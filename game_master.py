...
'''
class game:
    def __init__(self, l, agent_no = 0, num_player = 4, raise_amount = 5, agent_policy = 'random', iter = 0, ) -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", help="input file", type=str, required=False, default='/data/small.policy')
    parser.add_argument("-o", "--output", help="output file", type=str, required=False, default='/data/small.csv')
