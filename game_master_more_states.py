...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", help="input file", type=str, required=False, default='/data/big.policy')
    parser.add_argument("-o", "--output", help="output file", type=str, required=False, default='/data/big.csv')
